...
const perks = [
	{
		...
		description:
			"get your assets toyour email in seconds and download them rgiht away.",
	},
	{
		name: "Guaranteed Quality",
		icon: CheckCircle,
		description:
			"Every assests on our platform is verified by our team to ensure out highest quality standarts. Not happy? We offer 30-day refund guarantee.",
	},
	{
		name: "For the Planet",
		icon: Leaf,
							...
							return (
								...
								>
									...
									<div className="mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6">
										<h3 className="text-base font-medium text-gray900">
											{perk.name}
										</h3>
